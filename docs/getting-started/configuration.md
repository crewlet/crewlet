...
- **`transports`** — outbound delivery transports (e.g. `email`). The Jira/Confluence/Slack/Plane transports are auto-derived from the sections above; this list adds any others.
