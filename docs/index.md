...
- **[The Work Tracker](guides/work-tracker.md)** — The product guide to the engine's own tracker: projects and keys, everything a task carries, sprints, goals and how their progress is computed rather than stored, the catalogue of types and fields a company declares, the three view shapes and the three every container has without anybody saving one, manual board order and what a re-spread is, a person's own inbox, queue and pins and the three different authorities over them, the eleven tools a seat has and the three that count as a delivery, what a person reaches through the dashboard and their own assistant, and the difference between removing, deleting and purging
