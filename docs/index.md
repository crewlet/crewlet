...
- **[Agent Runtime](concepts/agent-runtime.md)**: how a configured role becomes a running seat, the states the dashboard shows, the built-in tools, and graceful shutdown
