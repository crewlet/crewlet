...
- **[The Work Tracker](guides/work-tracker.md)** — The product guide to the engine's own tracker: projects and keys, everything a task carries, sprints, goals and the three view shapes, manual board order and what a re-spread is, the five tools a seat has and the three that count as a delivery, what a person reaches through the dashboard and their own assistant, and the difference between removing, deleting and purging
