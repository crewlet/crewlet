...
- **[Read Consistency](guides/consistency.md)** — Picking how fresh an answer has to be: the four levels and what each costs, how `linearizable` works as a barrier append rather than a field check, every refusal code and its remedy, completeness as a fact separate from freshness, and the three things no level can strengthen
