...
//
// A nil surface is a node that bound no listener — api.port 0, or a node
// without the ingress role and with no tool bridge to serve — and it drains
// and stops the same way with nothing to close between the two.
