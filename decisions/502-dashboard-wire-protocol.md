...
**Status:** DECIDED · Applies to: `internal/api/stream/`,
...
than against a reading of the code at either end.

Where the two ends disagree, **the client wins** — it is the half that ships
unchanged.
