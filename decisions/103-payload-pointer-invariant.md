...
Status: decided
Supersedes: nothing
Related: `decisions/000-go-native-rewrite.md` (the safe-zero rule this
extends), `decisions/101-queue-contract.md`
...
with it under d-000: **wherever a Python default becomes a Go type decision,
