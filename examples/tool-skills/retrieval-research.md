...
- Your Confluence page-search tools — re-search team docs (`## Relevant knowledge`: playbooks, runbooks, ADRs, conventions) with a focused keyword query; open a full page body with your page-read tools.
