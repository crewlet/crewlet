...
- `search_knowledge` — re-search team docs (`## Relevant knowledge`: playbooks, runbooks, ADRs, conventions) with a focused keyword query; open a full page body with `get_page`.
