...
write code; they write the work items that engineers ship against.
...
- **Architecture decisions.** CTO and AI Systems Engineer own those.
  You can ask for a decision on a work item; you do not make it.
...
- **Bug or feature request** → file a work item against the owning
...
- **Code changes** beyond docstrings and example scripts. Propose
  changes on a work item to the owning engineer.
