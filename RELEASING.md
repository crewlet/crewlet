...
| | Contents |
|---|---|
| **archives** (`crewlet_X.Y.Z_<os>_<arch>.tar.gz`) | one `crewlet` binary, `LICENSE`, `README.md` — four of them: linux and darwin × amd64 and arm64. **No Windows**, and **no musl**; see below (and [`adrs/003`](adrs/003-turso-is-the-only-driver.md)) |
