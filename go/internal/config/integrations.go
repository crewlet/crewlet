...
type Jira struct {
	...
	Token string `yaml:"token" json:"token" js:"required" desc:"Admin API token or PAT; ${VAR} supported."`
	...
	WebhookSecret string `yaml:"webhook_secret,omitempty" json:"webhook_secret,omitempty" desc:"HMAC secret for inbound webhooks."`
}
...
type Confluence struct {
	...
	Token         string `yaml:"token" json:"token" js:"required" desc:"Admin API token or PAT; ${VAR} supported."`
	Email         string `yaml:"email,omitempty" json:"email,omitempty" desc:"Set for Cloud Basic auth; omit for bearer-token auth."`
	WebhookSecret string `yaml:"webhook_secret,omitempty" json:"webhook_secret,omitempty" desc:"HMAC secret for Data Center webhooks."`
}
...
type GitHub struct {
	...
	// anyone's POST.
	WebhookSecret string `yaml:"webhook_secret,omitempty" json:"webhook_secret,omitempty" desc:"HMAC secret for inbound deliveries."`
}
...
type GitLab struct {
	...
	SigningSecret string `yaml:"signing_secret,omitempty" json:"signing_secret,omitempty" desc:"Standard-Webhooks signing token; required when enabled."`
	...
	Token string `yaml:"token,omitempty" json:"token,omitempty" desc:"Read PAT for participants-based routing; empty degrades routing."`
...
type Plane struct {
	...
	WebhookSecret string `yaml:"webhook_secret,omitempty" json:"webhook_secret,omitempty" desc:"HMAC key; generated by Plane and captured by the provisioner."`
	...
	// learn from payloads.
	Token string `yaml:"token,omitempty" json:"token,omitempty" desc:"Engine read credential; empty degrades routing."`
