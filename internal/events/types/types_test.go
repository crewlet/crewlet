...
func catalogue() []events.Payload {
	return []events.Payload{
		...
		SubagentBatched{}, AuxiliaryCallCompleted{},
		// learning.go
		...
		// sandbox.go
		SandboxRunStarted{}, SandboxRunCompleted{}, SandboxAnswerReady{},
		SandboxRunFailed{}, SandboxClarificationRequested{},
		// turn.go
...
var wireTags = map[string][]string{
	...
	"agent_phase_completed":           {"abandoned_attempts", "abandoned_attempts_omitted", "agent_id", "backend", "coding_agent", "conversation_key", "cost_usd", "decision", "delivered_refs", "duration_ms", "empty_answer_rounds", "error", "error_kind", "exhausted_rounds", "failed", "host_iteration", "host_phase", "input_tokens", "iteration", "model", "models", "notes", "output_tokens", "output_truncated", "phase", "provider_key", "rescue_fired", "response", "role", "round_narration", "round_narration_omitted", "rounds_used", "run_spend_unreported", "sandbox_id", "system_prompt", "task_id", "tool_catalogue", "tool_executions", "tool_executions_omitted", "tools_available", "total_tokens", "trigger", "turn_id", "user_prompt", "whole_bytes", "whole_parts", "work_key", "worker"},
	"agent_phase_record_part":         {"data", "index", "offset", "record_id", "whole_bytes"},
	"agent_turn_progress":             {"a2a_context", "agent_id", "input_tokens", "iteration", "model", "output_tokens", "partial_round", "phase", "prompt", "prompt_messages", "response", "role", "round_narration", "round_narration_earlier", "round_num", "tool_executions", "tool_executions_earlier", "total_tokens", "trigger", "turn_id", "work_key"},
	"subagent_batched":                {"failures", "graph", "parent_handle", "statuses", "successes", "task_count", "total_tokens", "turn_id", "work_key"},
	"auxiliary_call_completed":        {"agent_id", "duration_ms", "input_tokens", "model", "output_tokens", "phase", "provider_key", "role", "total_tokens", "turn_id", "work_key", "worker"},
	...
	"sandbox_answer_ready":            {"agent_handle", "launch_id", "turn_id"},
