...
// Who owns a third-party app scope.
//
...
//
// # Why this is here rather than in each third-party app
//
...
// about the ORG, not about any third-party app, and three copies of it is three
// chances for one of them to answer differently from the others while each
// stays self-consistent.

// Scope is one third-party app's per-unit and per-seat identity, and how to read it.
type Scope struct {
...
// each third-party app reports the finding in its own vocabulary — an operator
...
//
// Scopes are keyed UPPER, because every third-party app this serves renders them
