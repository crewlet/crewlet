# adr-103 — Event.Data is always the pointer form, and a twin is a wire

Status: **Accepted**
Related: `adrs/000-invariants-that-outlive-refactors.md` (the safe-zero rule this
extends), `adrs/101-queue-contract.md`
