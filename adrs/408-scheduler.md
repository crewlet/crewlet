# adr-408 — The scheduler: a claim per tick, a ledger under it, and a horizon sized to the grammar

Status: **Accepted** · Applies to: `internal/schedule/`,
Related: `docs/concepts/scheduling.md`
...
Two seams are declared here and satisfied elsewhere:
