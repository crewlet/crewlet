# adr-203 — Secrets follow the config path

Status: **Accepted** — this record previously argued the opposite and was
wrong. See *The argument that did not hold* below, kept because a record that
quietly reverses itself teaches nobody why.
...
Six kinds of fleet-shared state moved onto the coordination KV under adr-201.
