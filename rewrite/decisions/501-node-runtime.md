# d-501 — NodeRuntime over request/reply
...
plan floated serving those over NATS request/reply — the lease table locates
the owner, the caller asks it directly — and left the envelope, timeouts and
authz to be decided.
