...
Status: **decided** · Phase: 3b · Method: measurement, not inference
...
- **The batch dispatch budget is deleted.** `_BATCH_DISPATCH_BUDGET_MS = 60 s`
  ...
  multi-minute turns would breach it mid-drain. There is no clock.
  REWRITE_PLAN §14B's own note — "exists ONLY because Pulsar's ack clock
  starts at receive — may be deletable" — resolves to *deleted*. This also
